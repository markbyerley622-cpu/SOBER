  ...
  return (
    <footer className="bg-sober-blue-darker/80 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                className="p-2 text-gray-400 hover:text-sober-blue transition-colors"
              >
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-gray-500 text-xs sm:text-sm">
          <p>&copy; {new Date().getFullYear()} $SOBER - Sober Made Fun. All rights reserved.</p>
